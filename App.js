...
const Footer = () => {
  return (
    <>
        ...
        <p className="socials"> 
          <a href="https://github.com/yakshi9" rel="noreferrer" target="_blank"><VscGithub size={25}/></a>
          <a href="https://www.linkedin.com/in/yakshi-garg-658442287?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" rel="noreferrer" target="_blank"><SiLinkedin size={25}/></a>
        </p>
        <p>
            <a href="https://github.com/yakshi9/To-do-" rel="noreferrer" target="_blank" className="source">$Source | 2023 - 2024</a> 
        </p> 
